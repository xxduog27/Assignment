...
<header>
    <div class="title">
        <p><a href="<%=request.getContextPath()%>/home" style="color: white; text-decoration: none">Mercedes-Benz</a></p>
        <div class="icon">
...
<main>
    <div class="css-container">
        <div class="menu">
            <div >
                <p><i class="fa fa-plus" aria-hidden="true"></i> <a href="<%=request.getContextPath()%>/my-product?action=add-car"> Add Product</a></p>
            </div>
            <div style="background-color: #2c3e50;color: whitesmoke">
                <p id="viewcontent"><i class="fa fa-product-hunt" aria-hidden="true"></i> <a href="<%=request.getContextPath()%>/EditProductServlet"  style="color: whitesmoke"> Edit Product</a></p>
            </div>
            <div>
                <p id="formcontent"><i class="fa fa-home" aria-hidden="true"></i> <a href="<%=request.getContextPath()%>/home"> Home</a></p>
            </div>
        </div>
        <div class="content">
            <div>
                <form action="<%=request.getContextPath()%>/editDetails" method="post">
                    <div style="color: red">*${requestScope.success}</div>
                    <div class="form-group">
                        <input hidden type="text" name="car_id" value="${requestScope.product.getProductId()}">
                        <div>
                            <div><img src="${product.productURLImg}" alt="car" id="car-img"></div>
                        </div>
                    </div>
                    <div class="form-row" >
                        <div class="form-group col-md-6">
                            <label for="product_name">Name</label>
                            <input type="text" class="form-control" id="product_name" name="product_name" value="${requestScope.product.getProductName()}">
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" value="${requestScope.product.getProductPrice()}" id="product_price" name="product_price">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="product_des" rows="3" name="product_des" >${requestScope.product.getProductDes()}</textarea>
                    </div>
