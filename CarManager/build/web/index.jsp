...
<div class="main-content">
    ...
    <div class="type-car">
        ...
        <button>Electric Car</button>
        <button>Hybrid Car</button>
        <button>Gasoline Car</button>
    </div>
    <div class="main-product">

        <div  onmouseover="callHover()" onmouseleave="deleteHover()">
            <div style="position: relative;">
                <img src="image/cabin.png" alt="Cabin" class="product-item">
                <div style="position: absolute;top: 0px;display: none;" id="car1">
                    <p>Loại xe điện</p>
                </div>
            </div>
        </div>
        <div>
            <img src="image/cake.png" alt="Cake" class="product-item">
        </div>
        <div>
            <img src="image/circus.png" alt="Circus" class="product-item">
        </div>
        <div>
            <img src="image/game.png" alt="Game" class="product-item">
        </div>
        <div>
            <img src="image/safe.png" alt="Safe" class="product-item">
        </div>
        <div>
            <img src="image/submarine.png" alt="Submarine" class="product-item">
        </div>
